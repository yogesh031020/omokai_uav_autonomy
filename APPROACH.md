...
6. **Yogesh's Past Work: -Project-TRINITY**
   * **URL:** [github.com/yogesh031020/-Project-TRINITY](https://github.com/yogesh031020/-Project-TRINITY)
   * **License:** MIT License
   * **Usage:** Used as the mathematical and algorithmic reference for multi-UAV coordinate offset transformations (Wedge and Line formations) designed in Challenge 1.

7. **Yogesh's Past Work: Autonomous-UAV-Trinity-Stack**
