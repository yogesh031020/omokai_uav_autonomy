...
* **Flight Demo Recordings:**
  1. **Gazebo 3D Simulation:** Located at `D:\Drone_Projects\Project_ICARUS\Project_TRINITY\docs\Core Task Gazebo.mp4` (showing the 3D drone trajectory).
...
* **Write-up Documentation:** `APPROACH.md` (detailing approach, safety architecture, challenges, and cited sources).
